    ...
    config: {
      ...
      scenarios: [
        ...
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--helfi-calculator'],
          selectorExpansion: expandComponents,
        },
        {
          label: 'DC: Chart',
        ...
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--contact-card-listing'],
          selectorExpansion: expandComponents,
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--content-cards'],
          selectorExpansion: expandComponents,
        },
        {
          label: 'DC: Event list',
        ...
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--liftup-with-image'],
          selectorExpansion: expandComponents,
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--list-of-links'],
          selectorExpansion: expandComponents,
        },
        {
          label: 'DC: Map',
        ...
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--popular-services'],
          selectorExpansion: expandComponents,
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--remote-video'],
          selectorExpansion: expandComponents,
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--service-list'],
          selectorExpansion: expandComponents,
        },
        {
        ...
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--target-group-links'],
          selectorExpansion: expandComponents,
        },
        {
          ...
          removeSelectors: removeDefault,
          selectors: ['.component--unit-search'],
          selectorExpansion: expandComponents,
        },
        // Form fields
        {
...
if (!process.env.DRUPAL_HOSTNAME || !process.env.COMPOSE_PROJECT_NAME) {
  process.exitCode = 1;
  console.error(
    `📕 Environment not found, are you sure the instance .env file can be found in ${envPath}?`,
  );
}
...
backstop(command, getConfig(hostname, protocol, type))
  .then(() => {
    console.log(
      `The ${command} command was successful! Check the report here: ${reportUrl}`,
    );
  })
  .catch((e) => {
