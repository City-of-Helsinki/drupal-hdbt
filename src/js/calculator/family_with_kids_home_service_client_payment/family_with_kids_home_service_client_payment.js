...
class FamilyWithKidsHomeServiceClientPayment {
...
window.helfi_calculator.family_with_kids_home_service_client_payment = (id, settings) => new FamilyWithKidsHomeServiceClientPayment(id, settings);
