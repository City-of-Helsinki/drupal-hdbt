  ...
  query: {
    bool: {
      should: [
        ...
        { term: { field_search_id: CustomIds.SUMMER_JOBS } },
        { term: { field_search_id: CustomIds.YOUTH_SUMMER_JOBS } },
        { term: { field_search_id: CustomIds.COOL_SUMMER_PROJECT } },
        { term: { field_search_id: CustomIds.TRAINING } },
        { term: { field_search_id: CustomIds.SEASONAL_JOB } },
      ],
