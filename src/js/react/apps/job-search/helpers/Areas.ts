...
export const getInitialAreaFilter = (
  key: string[] | string = '',
  options: OptionType[] = [],
) =>
...
export const getAreaInfo = [
  {
    ...
    label: Drupal.t(
      'Eastern area',
      {},
      { context: 'Search filter option: Eastern area' },
    ),
  ...
  },
  {
    ...
    label: Drupal.t(
      'Central area',
      {},
      { context: 'Search filter option: Central area' },
    ),
  ...
  },
  {
    ...
    label: Drupal.t(
      'Southern area',
      {},
      { context: 'Search filter option: Southern area' },
    ),
  ...
  },
  {
    ...
    label: Drupal.t(
      'South-Eastern area',
      {},
      { context: 'Search filter option: South-Eastern area' },
    ),
  ...
  },
  {
    ...
    label: Drupal.t(
      'Western area',
      {},
      { context: 'Search filter option: Western area' },
    ),
