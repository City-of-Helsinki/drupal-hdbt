...
class CookieHandler {
  ...
  getAllKeysInConsentedGroups(consentedGroupNames = null) {
    if (!consentedGroupNames) {
      consentedGroupNames = this.getConsentedGroupNames();
    }
    const consentedKeys = {};
    consentedKeys.cookie = this.#getKeysInConsentedGroups(consentedGroupNames, 1);
    ...
    consentedKeys.localStorage = this.#getKeysInConsentedGroups(consentedGroupNames, 2);
    consentedKeys.sessionStorage = this.#getKeysInConsentedGroups(consentedGroupNames, 3);
    consentedKeys.indexedDB = this.#getKeysInConsentedGroups(consentedGroupNames, 4);
    consentedKeys.cacheStorage = this.#getKeysInConsentedGroups(consentedGroupNames, 5);
