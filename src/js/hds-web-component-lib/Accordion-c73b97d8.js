import { x, i as i$2, _ as __decorate, e as e$1, s, c as classNames, y } from './IconAngleUp-2e1d15ac.js';
...
i$2`/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */
...
const booleanConverter = {
  ...
  toAttribute: value => lodash.toString(value)
};
const getCloseMessage = language => ({
  en: `Close`,
  fi: `Sulje`,
  sv: `Stäng`
})[language];
let AccordionHTMLElement = class AccordionHTMLElement extends s {
  constructor() {
    super(...arguments);
    this.card = false;
    this.border = false;
    ...
    this.hasCloseButton = () => !!this.closeButton;
  }
  ...
  get identifiers() {
    if (!this.identifierPrefix) this.identifierPrefix = this.id || lodash.uniqueId('accordion-');
      ...
      <div class='accordionHeader'>
        <div
          ...
          <div
            ...
            <div class="accordionHeaderIconWrapper" style=${i(this.isOpen ? {} : {
  ...
  renderCloseButton() {
    ...
    const className = classNames('hds-button', 'hds-button--supplementary', 'hds-button--theme-black', 'closeButton', this.closeButtonClassName);
    const handleKeyPress = e => {
      if (e.key === ' ') {
        this.toggleOpen(); // FIXME
      }
...
// TODO style
AccordionHTMLElement.styles = [i$2`
      ${styles}
    `];
AccordionHTMLElement = __decorate([e$1('hds-accordion')], AccordionHTMLElement);
var AccordionHTMLElement$1 = AccordionHTMLElement;

export { AccordionHTMLElement$1 as A };
